...
$('.one').click(function () {
    if (one == 1) {
        ...
        $(".one").attr("src", "1/7.jpg");
        one += 1;
    } else if (one == 7) {
        $(".one").attr("src", "1/8.jpg");
        one += 1;
    } else if (one == 8) {
        $(".one").attr("src", "1/9.jpg");
        one += 1;
    } else if (one == 9) {
        $(".one").attr("src", "1/10.jpg");
        one += 1;
    } else {
...
$('.three').click(function () {
    if (three == 1) {
        ...
        $(".three").attr("src", "3/7.jpg");
        three += 1;
    } else if (three == 7) {
        $(".three").attr("src", "3/8.jpg");
        three += 1;
    } else if (three == 8) {
        $(".three").attr("src", "3/9.jpg");
        three += 1;
    } else {
...
$('.four').click(function () {
    if (four == 1) {
        ...
        $(".four").attr("src", "4/4.jpg");
        four += 1;
    } else {
        $(".four").attr("src", "4/1.jpg");
        four = 1;
    }
})
...
$('.seven').click(function () {
    if (seven == 1) {
        ...
        $(".seven").attr("src", "7/7.jpg");
        seven += 1;
    } else if (seven == 7) {
        $(".seven").attr("src", "7/8.jpg");
        seven += 1;
    } else if (seven == 8) {
        $(".seven").attr("src", "7/9.jpg");
        seven += 1;
    } else if (seven == 9) {
        $(".seven").attr("src", "7/10.jpg");
        seven += 1;
    } else {
...
$('.nine').click(function () {
    if (nine == 1) {
        ...
        $(".nine").attr("src", "9/7.jpg");
        nine += 1;
    } else if (nine == 7) {
        $(".nine").attr("src", "9/8.jpg");
        nine += 1;
    } else if (nine == 8) {
        $(".nine").attr("src", "9/9.jpg");
        nine += 1;
    } else {
